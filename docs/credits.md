...
<tr>
    <td align="center">
        <a href="https://github.com/sample">
            <img src="/assets/profile.jpg" width="80;" alt="sample"/>
            <br />
            <sub><b>sample</b></sub>
        </a>
    </td>
...
<tr>
    <td align="center">
        <a href="https://github.com/VadimDor">
            <img src="/assets/profile.jpg" width="80;" alt="VadimDor"/>
            <br />
            <sub><b>Vadim Dor</b></sub>
        </a>
    </td>
 </tr>
</table>
...
[![Recent Star Gazers](https://reporoster.com/stars/dark/VadimDor/asdf-openssl2)](https://github.com/VadimDor/openssl2/stargazers)

[![Recent Forkers](https://reporoster.com/forks/dark/VadimDor/asdf-openssl2)](https://github.com/VadimDor/openssl2/network/members)

---

## Dependencies

This project definitely wouldn't have been quite so possible without the making use of the following package and components. Full credit and big kudos to their respective authors, who've done an amazing job in building and maintaining them. For a full breakdown of dependency licenses, please see [ACKNOWLEDGMENTS](https://github.com/VadimDor/openssl2/blob/main/ACKNOWLEDGMENTS.md)
...
Would you like to be listed here? Whatever your skill set, openssl2 plugin needs people like you to help support future development. Check out the [Contributing Page](/contributing.md) for ways that you can get involved. Huge thank you to everyone who has already contributed! 💖
